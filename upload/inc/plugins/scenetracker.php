...
<tr>
  ...
  $template[25] = array(
    ...
    "template" => '
<div class="st_calendar birthday">{$birthdaylink}</div>
   ',
    "sid" => "-2",
    "version" => "1.0",
    "dateline" => TIME_NOW
  ...
  $template[26] = array(
    ...
    "template" => '
<div class="st_mini_scenelink plot"><a href="plottracker.php?action=view&plid={$plot[\\\'plid\\\']}">{$plot[\\\'name\\\']}</a></div>
   ',
    "sid" => "-2",
    "version" => "1.0",
    "dateline" => TIME_NOW
...
/*einträge löschen, wenn ein thread gelöscht wird*/
